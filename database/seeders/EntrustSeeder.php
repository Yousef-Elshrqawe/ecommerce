...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       // $faker = Factory::create();
        ...
        $admin = User::create(['first_name' => 'Admin', 'last_name' => 'System', 'username' => 'Admin', 'email' => 'Admin@tilatuk.com', 'mobile' => '01016736771', 'status' => 1, 'email_verified_at' => now(), 'password' => bcrypt('123456789'), 'remember_token' => Str::random(10),]);
        $admin->attachRole($adminRole);
        $supervisor = User::create(['first_name' => 'Supervisor', 'last_name' => 'System', 'username' => 'supervisor', 'email' => 'supervisor@tilatuk.com', 'mobile' => '010167367711', 'status' => 1, 'email_verified_at' => now(), 'password' => bcrypt('123456789'), 'remember_token' => Str::random(10),]);
        $supervisor->attachRole($supervisorRole);
        $customer = User::create(['first_name' => 'customer', 'last_name' => 'System', 'username' => 'customer', 'email' => 'customer@tilatuk.com', 'mobile' => '010167367712', 'status' => 1, 'email_verified_at' => now(), 'password' => bcrypt('123456789'), 'remember_token' => Str::random(10),]);
        $customer->attachRole($customerRole);

  /*      for ($i = 1; $i <= 20; $i++) {
            $random_customer = User::create(['first_name' => $faker->firstName, 'last_name' => $faker->lastName, 'username' => $faker->userName, 'email' => $faker->unique()->safeEmail, 'mobile' => '010' . $faker->numberBetween(10000000, 99999999), 'status' => 1, 'email_verified_at' => now(), 'password' => bcrypt('123456789'), 'remember_token' => Str::random(10),]);$random_customer->attachRole($customerRole);
        }*/
        ...
        // انشاء  في  sidebar الصفحه الرئيسيه
        ...
        // STATES
        $showStates = Permission::create(['name' => 'show_states', 'display_name' => 'States', 'route' => 'states', 'module' => 'states', 'as' => 'states.index', 'icon' => 'fas fa-map-marker-alt', 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createStates = Permission::create(['name' => 'create_states', 'display_name' => 'Create State', 'route' => 'states', 'module' => 'states', 'as' => 'states.create', 'icon' => null, 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '0']);
        $displayStates = Permission::create(['name' => 'display_states', 'display_name' => 'Show State', 'route' => 'states', 'module' => 'states', 'as' => 'states.show', 'icon' => null, 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '0']);
        $updateStates = Permission::create(['name' => 'update_states', 'display_name' => 'Update State', 'route' => 'states', 'module' => 'states', 'as' => 'states.edit', 'icon' => null, 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '0']);
        $deleteStates = Permission::create(['name' => 'delete_states', 'display_name' => 'Delete State', 'route' => 'states', 'module' => 'states', 'as' => 'states.destroy', 'icon' => null, 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '0']);

        // CITIES

        $showCities = Permission::create(['name' => 'show_cities', 'display_name' => 'Cities', 'route' => 'cities', 'module' => 'cities', 'as' => 'cities.index', 'icon' => 'fas fa-university', 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createCities = Permission::create(['name' => 'create_cities', 'display_name' => 'Create City', 'route' => 'cities', 'module' => 'cities', 'as' => 'cities.create', 'icon' => null, 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '0']);
        $displayCities = Permission::create(['name' => 'display_cities', 'display_name' => 'Show City', 'route' => 'cities', 'module' => 'cities', 'as' => 'cities.show', 'icon' => null, 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '0']);
        $updateCities = Permission::create(['name' => 'update_cities', 'display_name' => 'Update City', 'route' => 'cities', 'module' => 'cities', 'as' => 'cities.edit', 'icon' => null, 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '0']);
        $deleteCities = Permission::create(['name' => 'delete_cities', 'display_name' => 'Delete City', 'route' => 'cities', 'module' => 'cities', 'as' => 'cities.destroy', 'icon' => null, 'parent' => $manageCountries->id, 'parent_original' => $manageCountries->id, 'parent_show' => $manageCountries->id, 'sidebar_link' => '1', 'appear' => '0']);
        ...
        // Slider
        $slider = Permission::create(['name' => 'manage_slider', 'display_name' => 'Slider', 'route' => 'slider', 'module' => 'slide', 'as' => 'slider.index', 'icon' => 'fas fa-slider', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '500',]);
        $slider->parent_show = $slider->id;
        $slider->save();
        $showSlider = Permission::create(['name' => 'show_slider', 'display_name' => 'Slider', 'route' => 'slider', 'module' => 'slide', 'as' => 'slider.index', 'icon' => 'fas fa-slider', 'parent' => $slider->id, 'parent_original' => $slider->id, 'parent_show' => $slider->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createSlider = Permission::create(['name' => 'create_slider', 'display_name' => 'Create Slider', 'route' => 'slider', 'module' => 'slide', 'as' => 'slider.create', 'icon' => null, 'parent' => $slider->id, 'parent_original' => $slider->id, 'parent_show' => $slider->id, 'sidebar_link' => '1', 'appear' => '0']);
        $displaySlider = Permission::create(['name' => 'display_slider', 'display_name' => 'Show Slider', 'route' => 'slider', 'module' => 'slide', 'as' => 'slider.show', 'icon' => null, 'parent' => $slider->id, 'parent_original' => $slider->id, 'parent_show' => $slider->id, 'sidebar_link' => '1', 'appear' => '0']);
        $updateSlider = Permission::create(['name' => 'update_slider', 'display_name' => 'Update Slider', 'route' => 'slider', 'module' => 'slide', 'as' => 'slider.edit', 'icon' => null, 'parent' => $slider->id, 'parent_original' => $slider->id, 'parent_show' => $slider->id, 'sidebar_link' => '1', 'appear' => '0']);
        $deleteSlider = Permission::create(['name' => 'delete_slider', 'display_name' => 'Delete Slider', 'route' => 'slider', 'module' => 'slide', 'as' => 'slider.destroy', 'icon' => null, 'parent' => $slider->id, 'parent_original' => $slider->id, 'parent_show' => $slider->id, 'sidebar_link' => '1', 'appear' => '0']);


        // Social Media
        $SocialMedia = Permission::create(['name' => 'manage_social_media', 'display_name' => 'Social Media', 'route' => 'social_media', 'module' => 'Social_media', 'as' => 'social_media.index', 'icon' => 'fa-solid fa-phone', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '505',]);
        $SocialMedia->parent_show = $SocialMedia->id;
        $SocialMedia->save();
        $showSocialMedia = Permission::create(['name' => 'show_social_media', 'display_name' => 'Social Media', 'route' => 'social_media', 'module' => 'Social_media', 'as' => 'social_media.index', 'icon' => 'fa-solid fa-phone', 'parent' => $SocialMedia->id, 'parent_original' => $SocialMedia->id, 'parent_show' => $SocialMedia->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createSocialMedia = Permission::create(['name' => 'create_social_media', 'display_name' => 'Create Social Media', 'route' => 'social_media', 'module' => 'Social_media', 'as' => 'social_media.create', 'icon' => null, 'parent' => $SocialMedia->id, 'parent_original' => $SocialMedia->id, 'parent_show' => $SocialMedia->id, 'sidebar_link' => '1', 'appear' => '0']);
        $displaySocialMedia = Permission::create(['name' => 'display_social_media', 'display_name' => 'Show Social Media', 'route' => 'social_media', 'module' => 'Social_media', 'as' => 'social_media.show', 'icon' => null, 'parent' => $SocialMedia->id, 'parent_original' => $SocialMedia->id, 'parent_show' => $SocialMedia->id, 'sidebar_link' => '1', 'appear' => '0']);
        $updateSocialMedia = Permission::create(['name' => 'update_social_media', 'display_name' => 'Update Social Media', 'route' => 'social_media', 'module' => 'Social_media', 'as' => 'social_media.edit', 'icon' => null, 'parent' => $SocialMedia->id, 'parent_original' => $SocialMedia->id, 'parent_show' => $SocialMedia->id, 'sidebar_link' => '1', 'appear' => '0']);
        $deleteSocialMedia = Permission::create(['name' => 'delete_social_media', 'display_name' => 'Delete Social Media', 'route' => 'social_media', 'module' => 'Social_media', 'as' => 'social_media.destroy', 'icon' => null, 'parent' => $SocialMedia->id, 'parent_original' => $SocialMedia->id, 'parent_show' => $SocialMedia->id, 'sidebar_link' => '1', 'appear' => '0']);
