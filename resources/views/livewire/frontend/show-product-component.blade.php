<div>
    <div class="row align-items-stretch mb-4">
        ...
        <div class="col-sm-3 pl-sm-0">
            <a
                wire:click="addToCart()"  class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0"
                 href="javascript:void(0);">Add to cart
            </a>
        </div>
    </div>
    <a wire:click="addToWishList()" class="btn btn-link text-dark p-0 mb-4" href="javascript:void(0);"><i class="far fa-heart mr-2"></i>Add to wish
        list</a>
</div>
