                ...
                <div class="col-lg-3 order-2 order-lg-1">
                            ...
                            @forelse($shop_category->appearedChildren as $sub_shop_category)
                                <li class="mb-2">
                                    <a class="reset-anchor"
                                       href="{{route('frontend.shop' , $sub_shop_category->slug)}}">{{$sub_shop_category->name}}</a>
                                </li>
                            @empty
                    ...
                    <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                        @forelse($shop_tags_menu as $shop_tag)
                            <li class="mb-2">
                                <a class="reset-anchor"
                                   href="{{route('frontend.shop_tag' , $shop_tag->slug)}}">{{$shop_tag->name}}</a>
                            </li>
                        @empty
                    ...
                    <div class="row mb-3 align-items-center">
                        <div class="col-lg-6 mb-2 mb-lg-0">
                            <p class="text-small text-muted mb-0">Showing {{ $products->firstItem() }}
                                –{{ $products->firstItem() }} of {{ $products->total() }} results</p>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="col-4" id="products-container-area">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <a class="d-block" href="{{'frontend.product' , $product->slug}}"><img
                                        ...
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                ...
                                                <li class="list-inline-item m-0 p-0"><a
                                                        ...
                                                        class="btn btn-sm btn-dark" href="javascript:void(0);">Add to
                                                        cart</a></li>
                                                <li class="list-inline-item mr-0"><a
                                                        ...
                                                        data-target="#productView" data-toggle="modal"><i
                                                            class="fas fa-expand"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <h6><a class="reset-anchor"
                                           href="{{'frontend.product' , $product->slug}}">{{ $product->name}}</a></h6>
