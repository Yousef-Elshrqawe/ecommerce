                            ...
                            <div class="p-5 my-md-4">
                                    ...
                                    @if($productModel->reviews_avg_rating  != '')
                                        @for($i = 0 ; $i < 5 ; $i++)
                                            <li class="list-inline-item m-0"><i
                                                    class="{{round($productModel->reviews_avg_rating) >= $i ? 'fas' : 'far'}} fa-star fa-sm text-warning"></i>
                                            </li>
                                        @endfor
                                    @else
                                ...
                                <div class="row align-items-stretch mb-4">
                                    ...
                                    <div class="col-sm-5 pl-sm-0">
                                        <a wire:click="addToCart()" href="javascript:void(0);"
                                           class="btn btn-sm btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0">
                                            Add to cart
                                        </a>
                                    </div>
                                </div>
                                <a wire:click="addToWishList()" href="javascript:void(0);"
                                   class="btn btn-link text-dark p-0"><i class="far fa-heart mr-2"></i>Add to
                                    wish list</a>
                            </div>
                        </div>
                    </div>
