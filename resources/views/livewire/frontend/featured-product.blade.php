                            ...
                            <div class="product-overlay">
                                <ul class="mb-0 list-inline">
                                    <li class="list-inline-item m-0 p-0">
                                        <a wire:click.prevent="addToWishList('{{ $featuredProduct->id }}')" class="btn btn-sm btn-outline-dark" href="javascript:void(0);">
                                    ...
                                    <li class="list-inline-item mr-0">
                                        <a wire:click.prevent="$emit('showProductModalAction' , '{{ $featuredProduct->slug }}')" class="btn btn-sm btn-outline-dark"
