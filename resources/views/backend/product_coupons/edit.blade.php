...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        <h6 class="m-0 font-weight-bold text-primary">Update Coupons {{$productCoupon->code}}</h6>
        <div class="ml-auto">
        ...
        <form action="{{ route('admin.product_coupons.update' , $productCoupon->id) }}" method="post">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="code" name="code" value="{{ old('code' , $productCoupon->code) }}" class="form-control">
                ...
                <div class="col-3">
                    ...
                    <select name="type" class="form-control">
                        <option value="">---</option>
                        <option value="fixed" {{ old('type' , $productCoupon->type) ==  'fixed' ? 'selected' : null }}> $</option>
                        <option value="percentage" {{ old('type' , $productCoupon->type) == 'percentage' ? 'selected' : null }}> %</option>
                    </select>
            ...
            <div class="row">
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="start_date" id="start_date" value="{{ old('start_date' ,$productCoupon->start_date->format('Y-m-d')) }}"
                               class="form-control">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="expire_date" id="expire_date" value="{{ old('expire_date' ,$productCoupon->expire_date->format('Y-m-d')) }}"
                               class="form-control">
                ...
                <div class="col-3">
                    <div class="form-group">
                        <label for="greater_than">Greater Then</label>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <textarea name="description" id="description" rows="3" class="form-control summernote">
...
@section('js')
    ...
    <script>
        ...
        $(function () {
            ...
            $('#start_date').change(function() {  // عشان  تاريخ  الانتهاء  مينفعش  يكون  قبل  تاريخ  البداء
                selected_ci_date ="";
