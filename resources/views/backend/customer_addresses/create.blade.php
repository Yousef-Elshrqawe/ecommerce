                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            {{--                                                                <option value="{{ $customer->id }}" {{ old('user_id') == $customer->id ? 'selected' : null }}>{{ $customer->full_name }}</option>--}}
                            {{--                                                            @empty--}}
                            {{--                                                            @endforelse--}}
                            {{--                                                        </select>--}}
        ...
        $(function () {
            $(".typeahead").typeahead({
                ...
                source: function (query, process) {
                    return $.get("{{ route('admin.customers.getCustomers') }}", {'query': query}, function (data) {
                        return process(data);
                    });
                },
            ...
            function populateStates()
            {
                ...
                $.get("{{ route('admin.states.getStates') }}", {country_id: countryIdVal}, function (data) {
            ...
            function populateCities()
            {
                ...
                $.get("{{ route('admin.cities.getCities') }}", {state_id: stateIdVal}, function (data) {
