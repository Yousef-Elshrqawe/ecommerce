...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit products {{$product->name}}</h6>
            <div class="ml-auto">
                    ...
                    <div class="col-3">
                        ...
                        <select name="product_category_id" class="form-control">
                            ...
                            @forelse($categories as $category)
                                <option
                                    value="{{ $category->id }}" {{ old('product_category_id') == $category->product_category_id ? 'selected' : null }}>{{ $category->name }}</option>
                            @empty
                            @endforelse
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select name="featured" class="form-control">
                            <option value="1" {{ old('featured',  $product->featured) == 1 ? 'selected' : null }}>Yas</option>
                ...
                <div class="row pt-4">
                    <div class="col-12">
                        ...
                        <div class="file-loading">
                            <input type="file" name="images[]" id="product-image" class="file-preview-image" multiple="multiple">
