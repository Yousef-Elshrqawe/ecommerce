                    ...
                    <tr>
                        <td>
                            @if ($customer->user_image != '')
                                <img src="{{ asset('assets/users/'. $customer->user_image) }}" width="90" height="90" style="border-radius: 50%"  alt="{{ $customer->FullName }}">
                            @else
                                <img src="{{ asset('assets/users/avatar.svg') }}" width="90" height="90" style="border-radius: 50%"  alt="{{ $customer->FullName }}">
                            @endif
                        </td>
                        <td>
