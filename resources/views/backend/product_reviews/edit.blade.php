            ...
            <form action="{{ route('admin.product_reviews.update', $productReview->id  ) }}" method="post" >
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name', $productReview->name) }}" class="form-control" required>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="email" value="{{ old('email', $productReview->email) }}" class="form-control" required>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" value="{{ $productReview->product->name }}" class="form-control" id="Product" required readonly>
                        <input type="hidden" name="product_id" value="{{ $productReview->product_id }}" class="form-control" required readonly>
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" value="{{ $productReview->user_id != '' ? $productReview->user->FullName : '' }}" class="form-control" required readonly>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" name="title" value="{{ $productReview->title }}" class="form-control" required>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <textarea name="message" class="form-control summernote">{{ $productReview->message }}</textarea>
